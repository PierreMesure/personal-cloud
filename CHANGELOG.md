...
- Replaced the Hetzner dynamic inventory file with an integrated `hcloud_discovery` role that fetches the server IP directly from the API using credentials in `vars.yml`.
